...
LiquidCrystal_I2C lcd(0x27,20,4); // change 0x27 to the value you get when you use the I2c scanner program. Once this is done the microcontroller we use will know how to interface with the lcd
void setup() {
